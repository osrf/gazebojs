...
// // test for publish
// var gazebo = gazebojs.Gazebo(); 
// gazebo.publish("gazebo.msgs.WorldControl",  "~/world_control", {pause:true});

// // test for subscribe
// var gazebo = new ( require('./index')).Gazebo();
// var m = [];
// gazebo.subscribe("gazebo.msgs.WorldStatistics", "~/world_stats", function(e,d){m.push(d)});
...
suite('topics', function() {
    ...
    test('camera topic', function(done) {
        gazebo.sim.modelFile(camera_uri );
